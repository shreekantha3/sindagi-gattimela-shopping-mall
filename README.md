# Gattimela shopping mall — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-gattimela-shopping-mall/
- **Repo:** `shreekantha3/sindagi-gattimela-shopping-mall` (branch `main` = source, `gh-pages` = deployed bundle)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-gattimela-shopping-mall/'` for GitHub Pages project-site hosting.
